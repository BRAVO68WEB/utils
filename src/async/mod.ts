import { AnyAsyncFunction, AnyFunctionReturning, ConstructorOf } from "../types";
import { redirectErrorsToConsole } from "../console/error";
 ...
 * @group Async
 */
export const sleepMod = (duration: number): Promise<void> => {
